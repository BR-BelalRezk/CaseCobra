        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <figure className=" absolute w-28 left-0 -top-20 hidden lg:block">
                <Image
                  src={snake1}
                  alt="snake-1"
                  className="w-full"
              ...
              <div className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <ul className="space-y-2">
                  ...
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="w-5 h-5 shrink-0 text-green-500" />5 year
                    print guarantee
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="w-5 h-5 shrink-0 text-green-500" />
      ...
      <section className=" bg-slate-100 py-24">
        <MaxWidthWrapper className=" flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className=" order-1 mt-2 tracking-tight text-center text-balance font-bold text-5xl md:text-6xl text-gray-900 !leading-tight">
              What our{" "}
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span className="p-0.5 text-white bg-slate-800">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Belal</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Rezk</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <figure className=" relative flex items-center flex-col md:grid grid-cols-2 gap-40">
              <Image
                src={arrow}
                alt="arrow"
                ...
                height={0}
              />
              <figure className=" relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-offset-gray-900/10 lg:rounded-2xl">
                <Image
                  src={horse}
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              <Check className="size-5  inline text-green-600 mr-1.5" />
            ...
            <li className="w-fit">
              <Check className="size-5  inline text-green-600 mr-1.5" />5 year
              print warranty
            </li>
